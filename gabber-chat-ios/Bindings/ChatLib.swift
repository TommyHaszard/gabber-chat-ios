...
fileprivate extension RustBuffer {
    ...
    static func from(_ ptr: UnsafeBufferPointer<UInt8>) -> RustBuffer {
        try! rustCall { ffi_ChatLib_rustbuffer_from_bytes(ForeignBytes(bufferPointer: ptr), $0) }
    }

    // Frees the buffer in place.
    // The buffer must not be used after this is called.
    func deallocate() {
        try! rustCall { ffi_ChatLib_rustbuffer_free(self, $0) }
    }
}
...
private func makeRustCall<T, E: Swift.Error>(
    ...
    uniffiEnsureChatLibInitialized()
...
public struct Message {
    ...
    public init(messageId: Data, userId: Data, content: String, createdAt: UInt64?, isFromUser: Bool) {
...
extension Message: Equatable, Hashable {
    public static func ==(lhs: Message, rhs: Message) -> Bool {
        ...
        if lhs.isFromUser != rhs.isFromUser {
            return false
        }
        return true
    }
...
public struct FfiConverterTypeMessage: FfiConverterRustBuffer {
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> Message {
        return
            try Message(
                ...
                isFromUser: FfiConverterBool.read(from: &buf)
        )
    }
    ...
    public static func write(_ value: Message, into buf: inout [UInt8]) {
        ...
        FfiConverterBool.write(value.isFromUser, into: &buf)
    }
}
...
public struct User {
    ...
    // Default memberwise initializers are never public by default, so we
    // declare one manually.
    public init(userId: Data, username: String, userType: UserType) {
        self.userId = userId
...
public enum DatabaseError: Swift.Error {
    ...
    case SyncError
    case InvalidLength(Int32,Int32
    )
}
...
public struct FfiConverterTypeDatabaseError: FfiConverterRustBuffer {
    ...
    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> DatabaseError {
        ...
        case 3: return .RetrievalError(
            try FfiConverterString.read(from: &buf)
            )
        case 4: return .SyncError
        case 5: return .InvalidLength(
            try FfiConverterInt32.read(from: &buf), 
            try FfiConverterInt32.read(from: &buf)
            )
    ...
    public static func write(_ value: DatabaseError, into buf: inout [UInt8]) {
        ...
        case let .InvalidLength(v1,v2):
            writeInt(&buf, Int32(5))
            FfiConverterInt32.write(v1, into: &buf)
            FfiConverterInt32.write(v2, into: &buf)
...
@_documentation(visibility: private)
#endif
fileprivate struct FfiConverterDictionaryTypeUserTypeMessage: FfiConverterRustBuffer {
    public static func write(_ value: [User: Message], into buf: inout [UInt8]) {
        let len = Int32(value.count)
        writeInt(&buf, len)
        for (key, value) in value {
            FfiConverterTypeUser.write(key, into: &buf)
            FfiConverterTypeMessage.write(value, into: &buf)
        }
    }

    public static func read(from buf: inout (data: Data, offset: Data.Index)) throws -> [User: Message] {
        let len: Int32 = try readInt(&buf)
        var dict = [User: Message]()
        dict.reserveCapacity(Int(len))
        for _ in 0..<len {
            let key = try FfiConverterTypeUser.read(from: &buf)
            let value = try FfiConverterTypeMessage.read(from: &buf)
            dict[key] = value
        }
        return dict
    }
}
public func createUser(name: String, publicKey: Data)throws   {try rustCallWithError(FfiConverterTypeDatabaseError_lift) {
    uniffi_ChatLib_fn_func_create_user(
        FfiConverterString.lower(name),
        FfiConverterData.lower(publicKey),$0
    )
}
}
public func initDatabase(path: String)throws   {try rustCallWithError(FfiConverterTypeDatabaseError_lift) {
    uniffi_ChatLib_fn_func_init_database(
        FfiConverterString.lower(path),$0
    )
}
}
public func loadCurrentUser(deviceId: Data)throws  -> User  {
    return try  FfiConverterTypeUser_lift(try rustCallWithError(FfiConverterTypeDatabaseError_lift) {
    uniffi_ChatLib_fn_func_load_current_user(
        FfiConverterData.lower(deviceId),$0
    )
})
}
public func loadCurrentUsersAndMessages()throws  -> [User: Message]  {
    return try  FfiConverterDictionaryTypeUserTypeMessage.lift(try rustCallWithError(FfiConverterTypeDatabaseError_lift) {
    uniffi_ChatLib_fn_func_load_current_users_and_messages($0
    )
})
}
public func loadMessagesByUserId(userId: Data)throws  -> [Message]  {
    return try  FfiConverterSequenceTypeMessage.lift(try rustCallWithError(FfiConverterTypeDatabaseError_lift) {
    uniffi_ChatLib_fn_func_load_messages_by_user_id(
        FfiConverterData.lower(userId),$0
    )
})
}
public func loadUser(userId: Data)throws  -> User  {
    return try  FfiConverterTypeUser_lift(try rustCallWithError(FfiConverterTypeDatabaseError_lift) {
    uniffi_ChatLib_fn_func_load_user(
        FfiConverterData.lower(userId),$0
    )
})
}
public func sendMessage(userId: Data, message: Message)throws   {try rustCallWithError(FfiConverterTypeDatabaseError_lift) {
    uniffi_ChatLib_fn_func_send_message(
...
private let initializationResult: InitializationResult = {
    ...
    let scaffolding_contract_version = ffi_ChatLib_uniffi_contract_version()
    if bindings_contract_version != scaffolding_contract_version {
        return InitializationResult.contractVersionMismatch
    }
    if (uniffi_ChatLib_checksum_func_create_user() != 48410) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_ChatLib_checksum_func_init_database() != 15784) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_ChatLib_checksum_func_load_current_user() != 48827) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_ChatLib_checksum_func_load_current_users_and_messages() != 16735) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_ChatLib_checksum_func_load_messages_by_user_id() != 23644) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_ChatLib_checksum_func_load_user() != 44069) {
        return InitializationResult.apiChecksumMismatch
    }
    if (uniffi_ChatLib_checksum_func_send_message() != 51004) {
        return InitializationResult.apiChecksumMismatch
    }
...
public func uniffiEnsureChatLibInitialized() {
